...
<a href="#" className="inline-block pb-2 text-lg font-bold dark:text-gray-400">Quiz App</a>
...
<span className="text-gray-800 dark:text-gray-400">+8801862086965</span>
</p>
</div>
</div>
</div>
...
<a href="#" className="inline-block w-full px-5 py-4 font-medium leading-4 text-center text-gray-100 bg-blue-700 rounded-md dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-blue-600">Subscribe</a>
</div>
</div>
</div>
</div>
